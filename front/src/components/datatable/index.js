...
export default function DataTable(props) {
  ...
  function remove(item) {
    if (props.resource === "matricula") {
      const aluno_id = item.aluno_id;
      const disciplina_id = item.disciplina_id;
      console.log(aluno_id, disciplina_id);

      Client.delete(`matriculas/${aluno_id}/${disciplina_id}`)
        .catch((error) => {
          console.error(error);
        });
    } else {
